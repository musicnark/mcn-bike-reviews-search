...
On MacOS, `M-x` means pressing `Option + x`. On Windows/Linux, it means `Alt + x`. After that, you type the name of the terminal to run — in this case `eshell`, or `ielm`, and hit enter to launch it.
