...
The current implementation is a standalone Clojure service. Moving beyond the editor removed the main barrier to wider use and created space for a documented JSON API, stronger validation, automated tests, and a future browser-based interface.
