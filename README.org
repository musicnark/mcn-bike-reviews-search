...
But, instead of sleeping on it, I took it upon myself to build it. This is a MVP that I used to pitch a full version to the business.
...
2) Individually accessing each bike review page from the live site
...
So for an example query, it looks like this:
