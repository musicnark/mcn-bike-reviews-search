...
But, instead of sleeping on it, I took it upon myself to build it. This is a MVP, implemented in Elisp, that I used to pitch a full version to the business. Stay tuned to see what the business' response is...
