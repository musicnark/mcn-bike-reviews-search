* TL;DR
- *Purpose:* Enable faster search of MCN's bike reviews, filtering by bike specs, for faster content ideation.
- *Tech:* Elisp, CSV import, DOM node tree traversal, hashmap storage, query language/DSL.
